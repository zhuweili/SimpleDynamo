    ...
    private class Task extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (testQuery()) {
                ...
                //new RunHandlerQue().update_screen("Query success");
            } else {
                publishProgress("Query fail\n");
                //new RunHandlerQue().update_screen("Query fail");
            }

           // mContentResolver.delete(mUri,"*",null);
//            PortNum PN=new PortNum();
//            Ring rs=new Ring();
//            Integer next_p=rs.return_next(PN.get_port_num());
//
//            test_alive test=new test_alive(next_p);
//            String ss="my next is ";
//
//            while(!test.is_alive()) {
//                next_p=rs.return_next(PN.get_port_num());
//                test=new test_alive(next_p);
//            }
//
//            ss=ss+next_p.toString();
//
